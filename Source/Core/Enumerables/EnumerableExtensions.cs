...
public static class EnumerableExtensions
{
   extension<T>(IEnumerable<T> enumerable)
   {
      ...
      public IEnumerable<(int index, T item)> Indexed()
      {
         var index = 0;
         foreach (var item in enumerable)
         {
      ...
      public IEnumerable<(int index, T item)> Indexed1()
      {
         var index = 1;
         foreach (var item in enumerable)
         {
      ...
      public Maybe<int> FirstIndexOrNone(Func<T, bool> predicate)
      {
         var index = 0;
         foreach (var item in enumerable)
         {
      ...
      public Result<int> FirstIndexOrFailure(Func<T, bool> predicate, string failureMessage = "Default value")
      {
         var index = 0;
         foreach (var item in enumerable)
         {
      ...
      public Result<int> FirstIndexOrFailure(Func<T, bool> predicate, Func<string> failureMessage)
      {
         var index = 0;
         foreach (var item in enumerable)
         {
      ...
      public Optional<int> FirstIndexOrEmpty(Func<T, bool> predicate)
      {
         var index = 0;
         foreach (var item in enumerable)
         {
      ...
      public Optional<int> FirstIndexOrFail(Func<T, bool> predicate, string failMessage = "Default value")
      {
         var index = 0;
         foreach (var item in enumerable)
         {
      ...
      public T FoldLeft(Func<T, T, T> foldFunc) => enumerable.Aggregate(foldFunc);

      public T FoldRight(Func<T, T, T> foldFunc)
      {
         List<T> list = [.. enumerable];
         if (list.Count == 0)
         {
      ...
      public TResult Fold<TResult>(Func<TResult, T, TResult> foldFunc, TResult defaultValue)
      ...
      public (IEnumerable<T> isTrue, IEnumerable<T> isFalse) Partition(Predicate<T> predicate)
      {
         List<T> isTrue = [];
         List<T> isFalse = [];
         foreach (var item in enumerable)
      ...
      public Maybe<int> IndexOfMax<TResult>(Func<T, TResult> mappingFunc)
      ...
      public Maybe<int> IndexOfMin<TResult>(Func<T, TResult> mappingFunc)
         where TResult : IComparable<TResult>
      {
         Maybe<int> _index = nil;
         var currentIndex = 0;
      ...
      public IEnumerable<T> For(Action<T> action)
      {
         foreach (var item in enumerable)
         {
            action(item);
      ...
      public IEnumerable<IEnumerable<T>> Cluster(int count)
      {
         T[] array = [.. enumerable];
      ...
      public IOrderedEnumerable<T> OrderBy<TMember>(Func<T, TMember> mapper,
      ...
      public IOrderedEnumerable<T> OrderByDescending<TMember>(Func<T, TMember> mapper,
         IEnumerable<TMember> orderItems) where TMember : notnull
      {
      ...
      public IEnumerable<T> Distinct<TKey>(Func<T, TKey> keySelector)
      {
      ...
      public Maybe<int> Find(T item, int startIndex = 0)
      {
         T[] array = [.. enumerable];
      ...
      public Maybe<int> Find(Func<T, bool> predicate, int startIndex = 0)
      {
         T[] array = [.. enumerable];
         for (var i = startIndex; i < array.Length; i++)
         {
      ...
      public IEnumerable<int> FindAll(T item, int startIndex = 0)
      {
         T[] array = [.. enumerable];
         for (var i = startIndex; i < array.Length; i++)
         {
   ...
   extension<T>(IEnumerable<IEnumerable<T>> source)
   {
      ...
      public IEnumerable<TResult> FlatMap<TResult>(Func<T, TResult> mapFunc)
      {
   ...
   extension(int from)
   {
      public IEnumerable<int> UpTo(int to, int by = 1)
      {
      ...
      public IEnumerable<int> UpUntil(int to, int by = 1)
      {
         for (var i = from; i < to; i += by)
         {
            yield return i;
      ...
      public IEnumerable<int> DownTo(int to, int by = -1)
      {
         for (var i = from; i >= to; i += by)
         {
            yield return i;
      ...
      public IEnumerable<int> DownUntil(int to, int by = -1)
      {
         for (var i = from; i > to; i += by)
         {
            yield return i;
      ...
      public IEnumerable<int> Range() => Enumerable.Range(0, from);
   }

   extension(char from)
   {
      public IEnumerable<char> UpTo(char to, int by = 1)
      {
      ...
      public IEnumerable<char> UpUntil(char to, int by = 1)
      {
         for (var i = from; i < to; i = (char)(i + by))
         {
            yield return i;
      ...
      public IEnumerable<char> DownTo(char to, int by = -1)
      {
         for (var i = from; i >= to; i = (char)(i + by))
         {
            yield return i;
      ...
      public IEnumerable<char> DownUntil(char to, int by = -1)
      {
         for (var i = from; i > to; i = (char)(i + by))
         {
            yield return i;
   ...
   extension<T>(IEnumerable<T> enumerable) where T : notnull
   {
      ...
      public IOrderedEnumerable<T> OrderBy(IEnumerable<T> orderItems)
      {
         var paired = getPaired(orderItems, int.MaxValue);
         return enumerable.OrderBy(i => paired[i]);
      }

      public IOrderedEnumerable<T> OrderByDescending(IEnumerable<T> orderItems)
      {
         var paired = getPaired(orderItems, int.MinValue);
         return enumerable.OrderByDescending(i => paired[i]);
      }

      public IEnumerable<TResult> Merge<T2, TResult>(IEnumerable<T2> right, Func<T, T2, TResult> map) where T2 : notnull
      {
         var leftQueue = new EnumerableQueue<T>(enumerable);
      ...
      public IEnumerable<(T left, T2 right)> Merge<T2>(IEnumerable<T2> right) where T2 : notnull
      {
         return enumerable.Merge<T, T2, (T, T2)>(right, (t1, t2) => (t1, t2));
      }
      ...
      public (Maybe<T> head, IEnumerable<T> tail) HeadAndTail()
      {
   ...
   extension<T1, T2>(IEnumerable<(T1, T2)> enumerable)
   {
      public Result<(T1, T2)> FirstOrFailure(Func<T1, T2, bool> predicate, string failureMessage = "Default value")
      {
         try
         {
      ...
      public Result<(T1, T2)> FirstOrFailure(Func<T1, T2, bool> predicate,
      ...
      public Result<(T1, T2)> LastOrFailure(Func<T1, T2, bool> predicate,
         string failureMessage = "Default value")
      {
         try
         {
      ...
      public Maybe<(T1, T2)> FirstOrNone(Func<T1, T2, bool> predicate)
      {
      ...
      public Maybe<(T1, T2)> LastOrNone(Func<T1, T2, bool> predicate)
      {
      ...
      public Optional<(T1, T2)> FirstOrEmpty(Func<T1, T2, bool> predicate)
      {
         return enumerable.FirstOrNone(predicate).Optional();
      }

      public Optional<(T1, T2)> LastOrEmpty(Func<T1, T2, bool> predicate)
      {
         return enumerable.LastOrNone(predicate).Optional();
      }

      public Optional<(T1, T2)> FirstOrFail(Func<T1, T2, bool> predicate,
         string failMessage = "Default value")
      {
         return enumerable.FirstOrFailure(predicate, failMessage).Optional();
      }

      public Optional<(T1, T2)> FirstOrFail(Func<T1, T2, bool> predicate, Func<string> failMessage)
      {
         return enumerable.FirstOrFailure(predicate, failMessage).Optional();
      }

      public Optional<(T1, T2)> LastOrFail(Func<T1, T2, bool> predicate,
         string failMessage = "Default value")
      {
         return enumerable.LastOrFailure(predicate, failMessage).Optional();
      }

      public Optional<(T1, T2)> LastOrFail(Func<T1, T2, bool> predicate, Func<string> failMessage)
      {
         return enumerable.LastOrFailure(predicate, failMessage).Optional();
      }

      public IEnumerable<(T1, T2)> For(Action<T1, T2> action)
      {
   ...
   extension<T1, T2, T3>(IEnumerable<(T1, T2, T3)> enumerable)
   {
      public Result<(T1, T2, T3)> FirstOrFailure(Func<T1, T2, T3, bool> predicate, string failureMessage = "Default value")
      {
         try
         {
      ...
      public Result<(T1, T2, T3)> FirstOrFailure(Func<T1, T2, T3, bool> predicate,
         Func<string> failureMessage)
      {
         try
         {
      ...
      public Result<(T1, T2, T3)> LastOrFailure(Func<T1, T2, T3, bool> predicate, string failureMessage = "Default value")
      {
         try
         {
      ...
      public Result<(T1, T2, T3)> LastOrFailure(Func<T1, T2, T3, bool> predicate, Func<string> failureMessage)
      {
         try
         {
            return enumerable.LastOrNone(i => predicate(i.Item1, i.Item2, i.Item3)).Result(failureMessage());
      ...
      public Maybe<(T1, T2, T3)> FirstOrNone(Func<T1, T2, T3, bool> predicate)
      {
      ...
      public Maybe<(T1, T2, T3)> LastOrNone(Func<T1, T2, T3, bool> predicate)
      {
      ...
      public Optional<(T1, T2, T3)> FirstOrEmpty(Func<T1, T2, T3, bool> predicate)
      {
         return enumerable.FirstOrNone(predicate).Optional();
      }

      public Optional<(T1, T2, T3)> LastOrEmpty(Func<T1, T2, T3, bool> predicate)
      {
         return enumerable.LastOrNone(predicate).Optional();
      }

      public Optional<(T1, T2, T3)> FirstOrFail(Func<T1, T2, T3, bool> predicate,
         string failMessage = "Default value")
      {
         return enumerable.FirstOrFailure(predicate, failMessage).Optional();
      }
      ...
      public Optional<(T1, T2, T3)> LastOrFail(Func<T1, T2, T3, bool> predicate,
         string failMessage = "Default value")
      {
         return enumerable.LastOrFailure(predicate, failMessage).Optional();
      }
      ...
      public IEnumerable<(T1, T2, T3)> For(Action<T1, T2, T3> action)
      {
   ...
   extension<T1, T2, T3, T4>(IEnumerable<(T1, T2, T3, T4)> enumerable)
   {
      public Result<(T1, T2, T3, T4)> FirstOrFailure(Func<T1, T2, T3, T4, bool> predicate, string failureMessage = "Default value")
      {
         try
         {
      ...
      public Result<(T1, T2, T3, T4)> FirstOrFailure(Func<T1, T2, T3, T4, bool> predicate, Func<string> failureMessage)
      {
         try
         {
            return enumerable.FirstOrNone(i => predicate(i.Item1, i.Item2, i.Item3, i.Item4)).Result(failureMessage());
      ...
      public Result<(T1, T2, T3, T4)> LastOrFailure(Func<T1, T2, T3, T4, bool> predicate, Func<string> failureMessage)
      {
         try
         {
      ...
      public Maybe<(T1, T2, T3, T4)> FirstOrNone(Func<T1, T2, T3, T4, bool> predicate)
      {
      ...
      public Maybe<(T1, T2, T3, T4)> LastOrNone(Func<T1, T2, T3, T4, bool> predicate)
      {
      ...
      public Optional<(T1, T2, T3, T4)> FirstOrEmpty(Func<T1, T2, T3, T4, bool> predicate)
      {
         return enumerable.FirstOrNone(predicate).Optional();
      }

      public Optional<(T1, T2, T3, T4)> LastOrEmpty(Func<T1, T2, T3, T4, bool> predicate)
      {
         return enumerable.LastOrNone(predicate).Optional();
      }

      public Optional<(T1, T2, T3, T4)> FirstOrFail(Func<T1, T2, T3, T4, bool> predicate, Func<string> failMessage)
      {
         return enumerable.FirstOrFailure(predicate, failMessage).Optional();
      }

      public Optional<(T1, T2, T3, T4)> LastOrFail(Func<T1, T2, T3, T4, bool> predicate, Func<string> failMessage)
      {
         return enumerable.LastOrFailure(predicate, failMessage).Optional();
      }

      public IEnumerable<(T1, T2, T3, T4)> For(Action<T1, T2, T3, T4> action)
      {
